...
2. Đọc mô tả project bên dưới, sau đó gọi **set_context** 3 lần để ghi nội dung thực tế (không để nguyên template) cho từng doc:
   ...
   Với mỗi lần gọi set_context: `project_id = "{{project_id}}"`, nội dung viết bằng markdown, súc tích, đủ để AI engineer dùng làm context khi sinh code.
